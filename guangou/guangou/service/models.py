...
class CourtDiscountCard(models.Model):
    ...
    courtid = models.ForeignKey(Court, models.DO_NOTHING, db_column='courtID', related_name='%(class)s_courtid')  # Field name made lowercase.
    discountcardtypeid = models.ForeignKey('CourtDiscountCardType', models.DO_NOTHING, db_column='discountCardTypeID', blank=True, null=True, related_name='%(class)s_discountcardtypeid')  # Field name made lowercase.
...
class UserCollectedCourt(models.Model):
    userid = models.ForeignKey(User, models.DO_NOTHING, db_column='userID', related_name='%(class)s_userid')  # Field name made lowercase.
    courtid = models.ForeignKey(Court, models.DO_NOTHING, db_column='courtID', related_name='%(class)s_courtid')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'user_collected_court'
...
class VenueBusinessCategory(models.Model):
    venueid = models.ForeignKey(Venue, models.DO_NOTHING, db_column='venueID', related_name='%(class)s_venueid')  # Field name made lowercase.
    businesscategoryid = models.ForeignKey(CourtType, models.DO_NOTHING, db_column='businessCategoryID', related_name='%(class)s_businesscategoryid')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'venue_business_category'
